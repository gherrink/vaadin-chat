package de.dhbw.lsmb.chat;

import de.dhbw.lsmb.chat.ui.*;
import de.dhbw.lsmb.chat.gwt.client.*;
...
@Widgetset("de.dhbw.lsmb.chat.gwt.chatWidgetSet")
@Theme("touchkit")
...
@PreserveOnRefresh
public class chatTouchKitUI extends UI {

    private final chatPersistToServerRpc serverRpc = new chatPersistToServerRpc() {
        @Override
